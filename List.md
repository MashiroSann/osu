...
| `PlaylistItemHandle` | `var control = new OsuUiKit.Containers.OsuRearrangeableListItem\`1+PlaylistItemHandle();` | `using OsuUiKit.Containers;` |
...
| `ReverseChildIDFillFlowContainer\`1` | `var control = new OsuUiKit.Containers.ReverseChildIDFillFlowContainer\`1();` | `using OsuUiKit.Containers;` |
| `SectionsContainer\`1` | `var control = new OsuUiKit.Containers.SectionsContainer\`1();` | `using OsuUiKit.Containers;` |
| `SelectionCycleFillFlowContainer\`1` | `var control = new OsuUiKit.Containers.SelectionCycleFillFlowContainer\`1();` | `using OsuUiKit.Containers;` |
...
| `UserTrackingScrollContainer\`1` | `var control = new OsuUiKit.Containers.UserTrackingScrollContainer\`1();` | `using OsuUiKit.Containers;` |
...
| `BreadcrumbControl\`1` | `var control = new OsuUiKit.UserInterface.BreadcrumbControl\`1();` | `using OsuUiKit.UserInterface;` |
...
| `ExpandableSlider\`1` | `var control = new OsuUiKit.UserInterface.ExpandableSlider\`1();` | `using OsuUiKit.UserInterface;` |
| `ExpandableSlider\`2` | `var control = new OsuUiKit.UserInterface.ExpandableSlider\`2();` | `using OsuUiKit.UserInterface;` |
...
| `OsuDropdown\`1` | `var control = new OsuUiKit.UserInterface.OsuDropdown\`1();` | `using OsuUiKit.UserInterface;` |
| `OsuDropdownHeader` | `var control = new OsuUiKit.UserInterface.OsuDropdown\`1+OsuDropdownHeader();` | `using OsuUiKit.UserInterface;` |
| `OsuDropdownMenu` | `var control = new OsuUiKit.UserInterface.OsuDropdown\`1+OsuDropdownMenu();` | `using OsuUiKit.UserInterface;` |
| `OsuEnumDropdown\`1` | `var control = new OsuUiKit.UserInterface.OsuEnumDropdown\`1();` | `using OsuUiKit.UserInterface;` |
...
| `OsuTabControl\`1` | `var control = new OsuUiKit.UserInterface.OsuTabControl\`1();` | `using OsuUiKit.UserInterface;` |
| `OsuTabDropdown\`1` | `var control = new OsuUiKit.UserInterface.OsuTabDropdown\`1();` | `using OsuUiKit.UserInterface;` |
...
| `PageTabControl\`1` | `var control = new OsuUiKit.UserInterface.PageTabControl\`1();` | `using OsuUiKit.UserInterface;` |
...
| `RoundedSliderBar\`1` | `var control = new OsuUiKit.UserInterface.RoundedSliderBar\`1();` | `using OsuUiKit.UserInterface;` |
| `SliderNub` | `var control = new OsuUiKit.UserInterface.RoundedSliderBar\`1+SliderNub();` | `using OsuUiKit.UserInterface;` |
...
| `ShearedSliderBar\`1` | `var control = new OsuUiKit.UserInterface.ShearedSliderBar\`1();` | `using OsuUiKit.UserInterface;` |
...
| `SlimEnumDropdown\`1` | `var control = new OsuUiKit.UserInterface.SlimEnumDropdown\`1();` | `using OsuUiKit.UserInterface;` |
...
| `FormDropdown\`1` | `var control = new OsuUiKit.UserInterfaceV2.FormDropdown\`1();` | `using OsuUiKit.UserInterfaceV2;` |
| `FormEnumDropdown\`1` | `var control = new OsuUiKit.UserInterfaceV2.FormEnumDropdown\`1();` | `using OsuUiKit.UserInterfaceV2;` |
| `FormFieldCaption` | `var control = new OsuUiKit.UserInterfaceV2.FormFieldCaption();` | `using OsuUiKit.UserInterfaceV2;` |
| `FormSliderBar\`1` | `var control = new OsuUiKit.UserInterfaceV2.FormSliderBar\`1();` | `using OsuUiKit.UserInterfaceV2;` |
| `InnerSlider` | `var control = new OsuUiKit.UserInterfaceV2.FormSliderBar\`1+InnerSlider();` | `using OsuUiKit.UserInterfaceV2;` |
| `InnerSliderNub` | `var control = new OsuUiKit.UserInterfaceV2.FormSliderBar\`1+InnerSliderNub();` | `using OsuUiKit.UserInterfaceV2;` |
...
| `LabelledSliderBar\`1` | `var control = new OsuUiKit.UserInterfaceV2.LabelledSliderBar\`1();` | `using OsuUiKit.UserInterfaceV2;` |
...
| `ShearedDropdownHeader` | `var control = new OsuUiKit.UserInterfaceV2.ShearedDropdown\`1+ShearedDropdownHeader();` | `using OsuUiKit.UserInterfaceV2;` |
